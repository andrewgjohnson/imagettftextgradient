...
The project uses [PHPUnit](https://phpunit.de/) framework to run unit tests. The tests are all located in the [`tests` folder](https://github.com/andrewgjohnson/imagettftextgradient/tree/master/tests). All tests should continue to pass and all new features should ideally include unit tests. Run this command to execute all unit tests:
...
In order to participate your behaviour must conform to our [code of conduct](https://github.com/andrewgjohnson/imagettftextgradient/blob/master/.github/CODE_OF_CONDUCT.md).